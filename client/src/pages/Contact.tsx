...
export default function Contact() {
  ...
  return <div className="contact-page" dir={direction}>
    ...
    <header className="contact-page__nav"><Link href="/" className="contact-page__brand"><span className="brand-monogram" aria-hidden="true">P</span><span>Panco</span></Link><nav><Link href="/#shop">{locale === "ar" ? "المتجر" : locale === "fr" ? "Boutique" : "Shop"}</Link><Link href="/#story">{locale === "ar" ? "الاستوديو" : locale === "fr" ? "Atelier" : "Studio"}</Link></nav></header>
