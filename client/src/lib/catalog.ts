...
export const catalogProducts: Product[] = [
  {
    ...
    colors: [
      ...
      { name: "Night brown", color: "#352a2a", image: "/manus-storage/north-atelier-cardholder_12ba7095.jpg" },
    ],
    tag: "New",
  ...
  },
  {
    ...
    gallery: ["/manus-storage/north-atelier-tote_a6b855c4.jpg", "/manus-storage/north-atelier-workshop_151c4843.jpg", "/manus-storage/north-atelier-hero_6fac9d50.jpg"],
    swatches: ["#A45F3D", "#8A593C"],
    colors: [
      { name: "Saddle", color: "#A45F3D", image: "/manus-storage/north-atelier-tote_a6b855c4.jpg" },
  ...
  },
  {
    ...
    gallery: ["/manus-storage/north-atelier-weekender_e238bcf4.webp", "/manus-storage/north-atelier-workshop_151c4843.jpg", "/manus-storage/north-atelier-cardholder_12ba7095.jpg"],
    swatches: ["#A55E33", "#633B22"],
    colors: [
      { name: "Cedar", color: "#A55E33", image: "/manus-storage/north-atelier-weekender_e238bcf4.webp" },
  ...
  },
  {
    ...
    gallery: ["/manus-storage/north-atelier-hero_6fac9d50.jpg", "/manus-storage/north-atelier-workshop_151c4843.jpg", "/manus-storage/north-atelier-tote_a6b855c4.jpg"],
    swatches: ["#6D3D24", "#352B22"],
    colors: [
      { name: "Oxhide", color: "#6D3D24", image: "/manus-storage/north-atelier-hero_6fac9d50.jpg" },
      { name: "Dark umber", color: "#352B22", image: "/manus-storage/north-atelier-tote_a6b855c4.jpg" },
    ],
