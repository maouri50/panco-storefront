...
export const productCopy = {
  en: {
    back: "Back to the atelier", available: "Cash on Delivery available", ledger: "Panco / Product ledger", object: "Panco object", details: "Details", taxes: "Taxes and delivery calculated at confirmation.", dispatch: "Available for studio dispatch", run: "Small workshop run", color: "Color", add: "Add to bag", order: "Order with Cash on Delivery", closeOrder: "Close order details", easyOrder: "Easy order / Cash on Delivery", deliverySimple: "Delivery, made\nsimple.", deliveryNote: "Payment is collected only when your delivery arrives.", fullName: "Full name", phone: "Phone number", address: "Delivery address", city: "City", note: "Order note", confirm: "Confirm Cash on Delivery request", cashTitle: "Cash on Delivery", cashBody: "We confirm delivery details before dispatch, then the courier collects the order total at your door.", customerNotes: "Reviews", noNotes: "No reviews\nyet.", noNotesBody: "This object has no published reviews yet. When genuine customer feedback is available, it will appear here.", related: "You may also\nlike these.", viewEdit: "View the studio edit", ask: "Ask about this object", quantity: "Quantity", added: "Added to your bag", continueCod: "Continue with Cash on Delivery", keepBrowsing: "Keep browsing",
  },
  ar: {
    back: "العودة إلى الاستوديو", available: "الدفع عند الاستلام متاح", ledger: "بانكو / سجل المنتجات", object: "قطعة من بانكو", details: "التفاصيل", taxes: "تُحسب الضرائب والتوصيل عند التأكيد.", dispatch: "متاح للشحن من الاستوديو", run: "دفعة صغيرة من الورشة", color: "اللون", add: "أضف إلى الحقيبة", order: "اطلب بالدفع عند الاستلام", closeOrder: "إغلاق تفاصيل الطلب", easyOrder: "طلب سهل / الدفع عند الاستلام", deliverySimple: "توصيل\nبكل بساطة.", deliveryNote: "يتم الدفع فقط عند وصول طلبك.", fullName: "الاسم الكامل", phone: "رقم الهاتف", address: "عنوان التوصيل", city: "المدينة", note: "ملاحظة الطلب", confirm: "تأكيد طلب الدفع عند الاستلام", cashTitle: "الدفع عند الاستلام", cashBody: "نؤكد تفاصيل التوصيل قبل الشحن، ثم يستلم المندوب قيمة الطلب عند بابك.", customerNotes: "التقييمات", noNotes: "لا توجد\nتقييمات بعد.", noNotesBody: "لا توجد تقييمات منشورة لهذه القطعة حتى الآن. ستظهر آراء العملاء الحقيقية هنا عند توفرها.", related: "قد تعجبك\nهذه القطع أيضاً.", viewEdit: "شاهد تشكيلة الاستوديو", ask: "اسأل عن هذه القطعة", quantity: "الكمية", added: "أُضيف إلى حقيبتك", continueCod: "تابع إلى الدفع عند الاستلام", keepBrowsing: "تابع التصفح",
  },
  fr: {
    back: "Retour à l’atelier", available: "Paiement à la livraison disponible", ledger: "Panco / Registre produit", object: "Objet Panco", details: "Détails", taxes: "Taxes et livraison calculées à la confirmation.", dispatch: "Disponible pour expédition atelier", run: "Petite série d’atelier", color: "Couleur", add: "Ajouter au sac", order: "Commander avec paiement à la livraison", closeOrder: "Fermer les détails", easyOrder: "Commande simple / Paiement à la livraison", deliverySimple: "Livraison,\ntout simplement.", deliveryNote: "Le paiement est collecté seulement à la livraison.", fullName: "Nom complet", phone: "Téléphone", address: "Adresse de livraison", city: "Ville", note: "Note de commande", confirm: "Confirmer la commande à la livraison", cashTitle: "Paiement à la livraison", cashBody: "Nous confirmons les détails avant l’expédition, puis le livreur collecte le montant à votre porte.", customerNotes: "Avis", noNotes: "Pas encore\nd’avis.", noNotesBody: "Cet objet n’a pas encore d’avis publiés. Les retours authentiques apparaîtront ici lorsqu’ils seront disponibles.", related: "Vous aimerez\npeut-être aussi.", viewEdit: "Voir la sélection atelier", ask: "Poser une question sur cet objet", quantity: "Quantité", added: "Ajouté à votre sac", continueCod: "Continuer avec paiement à la livraison", keepBrowsing: "Continuer à parcourir",
  },
} as const;
